...
|----------|----------------------|----------|-------------|
| **Paris** | +0.7°C | SSP1-2.6 | International commitments met; significant emission cuts |
| **Moderate** | +1.6°C | SSP2-4.5 | Current trends continue; no new aggressive mitigation |
| **High** | +2.5°C | SSP3-7.0 | Countries scale back mitigation; fragmented response |
| **Hot** | +3.5°C | SSP3-7.0 (90th pctile) | Same emissions as High but using the 90th percentile of temperature increases |
