...
You will run a full Uganda projection in ten minutes, before anything is explained. Then you will meet the one equation that produces it, and see how seven modules each move exactly one of its terms. The module closes with the evidence that the Python tool agrees with the IMF's Excel workbook, so you can decide now whether to trust the numbers.
:::
