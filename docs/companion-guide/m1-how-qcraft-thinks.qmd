...
```{mermaid}
%%| fig-cap: "This module covers the middle of the chain: the three numbers, and the equation they feed."
%%| fig-width: 6
flowchart LR
    ...
    style R fill:#1ABC9C,stroke:#2C3E50,color:#fff
    style P fill:#1ABC9C,stroke:#2C3E50,color:#fff
