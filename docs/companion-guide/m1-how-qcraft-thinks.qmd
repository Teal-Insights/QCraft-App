...
**Read the last column carefully.** The Explorer exposes ten controls in the sidebar, counting the country selection, every one starts at an engine default, and every one lands on exactly one of the three numbers. Choosing them, and writing down why, is @sec-m3's whole job.
