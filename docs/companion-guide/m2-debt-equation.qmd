...
**Observe.** Open the [Q-CRAFT Explorer](https://tealinsights.shinyapps.io/q-craft_explorer1/), select that country and read the Baseline tab. Note the debt trajectory, then look at the Fiscal Balances chart and note whether the primary balance is in surplus or deficit.
