...
**Forty-nine points of GDP is a large number to take on trust.** Both runs load the same Kenyan data. Both start from the same debt stock. Both use the same equation. One of them assumes the world warms along a hot path, and seventy years later the debt ratio is nearly double.
...
## Fast path
No route skips this module. If you already own the debt dynamics equation, treat Step 1 as about twenty minutes of revision, then read Steps 2 and 3 in full: they are where the tool is assembled, and they are new material for almost everyone.
:::
...
**Now divide by GDP, because a debt stock in currency units means nothing until it is set against the economy carrying it.** The numerator grows at the interest rate. The denominator grows at the rate of nominal GDP. Two things are racing:
...
**Start a country at 60 percent of GDP.** Give it an effective interest rate of 8 percent, nominal growth of 6 percent, and a primary deficit of 1 percent of GDP. (If you opened the depth layer in @sec-m1, this is the same year. What is new is what the next two years do.)
...
**Only one of the 2.1 points came from a decision.** One point came from borrowing, which everyone expects. The other 1.1 points came from the amplifier, which nobody voted for.

**Run it three years and the amplifier's contribution grows, because it applies to a bigger stock each time.**
...
Take one point off growth, to 5 percent, and the required surplus rises from 1.4 to 1.9 percent of GDP. The bill for standing still went up by half a point because a macro variable moved. Hold that thought until Step 3. A climate scenario there does exactly this and nothing else.
...
**Step 1 lands here: three numbers a year in, a debt path out.** Give me $r$, $g$ and $pb$ every year and I will give you the debt path. The rest of the model exists to supply those three.
...
**An equation that needs $r$, $g$ and $pb$ is useless until something produces them for 2030, and 2031, and every year to 2099.** That is the bulk of Q-CRAFT. It is three separate small machines. This step takes them in the order the equation reads: growth, then the primary balance, then the interest rate.
...
- **Employment growth** comes from the UN's World Population Prospects, working-age population aged 15 to 64. The only choice you make is the variant, Medium by default. The numbers arrive with the country.
...
**The toy numbers put Kenya's 2050 nominal growth at 6.36 percent.** Kenya in 2050 has employment growing at 1.45 percent, productivity at 1.29 and inflation at 3.50. Multiply: $(1.0145)(1.0129)(1.0350) = 1.0636$, so $g$ is 6.36 percent.
...
**A Q-CRAFT chart is two different objects glued together: a short WEO forecast, then a long mechanical extrapolation of assumptions you chose.** Nobody is forecasting 2087. The tool is answering what happens if these rates hold.

**The handover year is your country's own.** The handover falls at the last year the release reports the figures this country's projection needs, and never later than 2029. For almost every country that is 2029. The model takes over in 2030. For a few the release stopped reporting them much earlier: on the October 2024 data Syria's last reported year is 2010, so nearly the whole of its chart is projection. The shaded band is drawn at the country's own year rather than at a fixed 2029, and where the release ran on past a country's last reported figures the Explorer puts a notice above the results naming the year it anchored on. Check that year before you quote a date.
...
**The two demographic terms count different people.** Growth uses the working-age population, because that is who works. Spending uses the total population, because that is who is served. In a country whose workforce shrinks faster than its population, those two pull in opposite directions, and that is the fiscal squeeze demography produces on its own with no climate anywhere near it.
...
**The toy numbers put the wedge at 0.59 percent of GDP.** Kenya's revenue settles at 19.81 percent of GDP and stays there for seventy years, because that is what the rule says. Primary expenditure in 2050 is 19.22 percent. The wedge is 0.59 percent of GDP, and that is the primary balance the equation gets for that year.

**The wedge equals the debt-stabilizing balance, because the fiscal rule is on.** Step 1 already told you how to check. Kenya's debt-stabilizing primary balance in 2050 is 0.59 percent of GDP. The two are the same number to two decimal places, which is not a coincidence: holding debt at the target is what the rule does.
...
**The effective interest rate is the average rate the government pays on its whole stock of debt.** It is not a market yield. Q-CRAFT does not model one. Q-CRAFT offers three rules for projecting it forward, and they are three different views about what stays constant.
...
**For Kenya the three rules give an effective rate in 2099 of 7.6, 2.1 and 4.5 percent.** All three baselines end at 51 percent of GDP, because the fiscal rule is doing the work in each of them. Under the Hot scenario no rule intervenes. They end at 100, 69 and 77.

**One dropdown creates thirty-one points of GDP of disagreement, with every other assumption identical.** This is the single assumption that moves a climate answer most, and the Explorer puts it in the sidebar as the interest-rate approach control, running the constant-nominal rule by default. If the answer matters, run all three approaches and report the spread.
...
**The climate part of Q-CRAFT is smaller than most people expect.** It is a table of numbers, one per country per scenario per year, that says how much smaller GDP is than it would otherwise have been. This step is where that table comes from.

### Step 3a. The econometrics measures deviation from a country's own norm

**The estimates behind every climate number in Q-CRAFT trace to one paper: [Kahn, Mohaddes, Ng, Pesaran, Raissi and Yang (2021)](references.qmd#src-kahn-2021), "Long-term macroeconomic effects of climate change", published in *Energy Economics*.** Here is what it did, in the order the argument runs.

**It used a long global panel.** The panel covered 174 countries with annual data from 1960 to 2014. It was neither a simulation of a warmer world nor a small sample of hot countries. It set fifty-five years of every country's growth against fifty-five years of every country's weather.

**The variable that does the work is deviation, not heat.** This move sets the paper apart from most of the literature. The regressor is not a country's temperature. It is the gap between this year's temperature and that country's own historical norm, where the norm is a moving average of the past thirty years. A country at 25 degrees that has always been at 25 degrees is at its norm and the model expects no effect. A country at 8 degrees that has always been at 6 is two degrees above its norm and the model expects one.

**The paper states the reason for building it this way: temperature is trended in almost every country, so putting the level into a growth regression forces a trend into growth that the data does not show.** Deviations have no trend, so they can be used.
...
**Adaptation is how fast the norm catches up.** Slow down here, because this is where the tool's adapted and unadapted scenarios come from.
...
**The adaptation window sets Kenya's 2099 Hot shortfall at 2.33, 4.20 or 6.99 percent.** Kenya's cumulative GDP shortfall under the Hot scenario in 2099 is 4.20 percent. The same temperature path with a twenty-year window gives 2.33 percent. With a fifty-year window it gives 6.99 percent.
...
**Two of the three ingredients are country-specific, and the third is not.** Be exact about which is which.
...
**The Hot run falls more than two points short of what Step 1 says it needs.** The baseline needs 1.47 to hold its ratio still and runs 1.41, so it is roughly stable. The Hot run needs 2.86 and runs 0.71, so it is short by more than two points of GDP every year, on a debt stock that is already twice as large. That is what a spiral looks like. It is why the fan in the cold open bends upward rather than drifting.
...
**How the shortfall becomes a growth rate.** The climate table holds a cumulative GDP index shortfall for each year. The engine takes the year-on-year percent change of that index and adds it to the baseline's productivity growth rate for that year. For Kenya in 2099 the baseline productivity growth is 1.200 percent and the Hot run's is 1.142, a difference of 0.058 percentage points. That single year's cut is almost invisible. Seventy of them compounded, against an interest rate that does not move, is the entire result.
...
**Twenty years in, the gap is already two and a half points.** Then run the same arithmetic forty-nine more times, each on a stock that is a little larger than the last, with a primary balance that falls further behind what the equation needs, and against a fiscal rule that holds the baseline down but never touches the scenario.
...
2. **Employment growth, from the UN World Population Prospects.** With productivity and inflation held identical, the only remaining term in $(1+e)(1+p)(1+i)$ is employment, which comes from the working-age population projection. The only handle the tool gives you is the demography variant, Medium, High or Low. The two countries in the chapter are Kenya at plus 1.45 percent and Thailand at minus 1.11. Nothing about either country's climate exposure, borrowing or policy enters this answer.
...
**The next three modules choose the controls, run a country end to end, and draw the boundary.** Steps 2 and 3 named the sidebar's ten controls and treated them as given. @sec-m3 is where you choose them, one at a time, with the evidence you would cite for each. @sec-m4 runs a country end to end and writes the result up. @sec-m5 draws the boundary of what any of it supports.

**On your desk this week: compute your country's debt-stabilizing balance and compare it to the actual.** Open the Explorer, pick your own country, and read the 2050 row off the Data tab's grid: the debt ratio and the primary balance. Take your own view of the interest-growth gap from whatever your ministry's framework assumes. Then compute the debt-stabilizing primary balance from Step 1 and compare it to the actual. That is one division. The comparison is the sentence most credible fiscal risk write-ups open with.
