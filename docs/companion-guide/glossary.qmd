...
: An IMF dynamic general equilibrium model of natural disasters and public investment in developing countries. As a general equilibrium model it carries far more structure than Q-CRAFT's single recursion. Discussed in the co-design appendix as an example of a tool that could benefit from the SovTech approach.
