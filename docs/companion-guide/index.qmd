...
1. **Data currency.** A posted workbook ships with the [WEO](glossary.qmd#gloss-weo) vintage it was built on, and that vintage ages between releases. The Explorer's bundled data is kept current.
