# Start here: what you will walk into your minister's office with {#sec-m0}
...
2. **A two-paragraph draft** in the register of Uganda's Fiscal Risk Statement, suitable for handing to whoever owns your ministry's fiscal risk chapter.

That packet is the capstone. It is what you walk into your minister's office with. @sec-m6 contains the brief and the rubric it will be marked against. Every module in between either feeds that packet or tells you when not to trust it.
...
```{mermaid}
%%| fig-cap: "The course map. Country data and your assumptions are manufactured into the three numbers the debt equation needs. This module fixes the destination on the right."
%%| fig-width: 6
flowchart LR
