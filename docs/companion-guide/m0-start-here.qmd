# Start here: the analysis you will defend {#sec-m0}

::: {.callout-important}
## DRAFT FOR TEAL: title amendment
This title changed in run 3. It was "Start here: what you will walk into your minister's office with", and before that the Permanent Secretary's office. The course now addresses ministries that do not share an org chart, so the title names the performance rather than the office. Two alternatives are staged at the top of `MORNING-REPORT.md`. Pick one and this callout goes.
:::
...
## The deliverable already exists, and a ministry has already published it
...
::: {.callout-note}
## A note on time
Budget three to four times whatever you think this will take. That ratio is the standard finding on expert time estimates for other people's learning, and it holds here. The ten-minute run in @sec-m1 does take ten minutes. The rest does not.
:::
