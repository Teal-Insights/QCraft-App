# Appendix: from Q-CRAFT to the LIC-DSF {#sec-appendix-codesign}
...
[Q-CRAFT Explorer](https://tealinsights.shinyapps.io/q-craft_explorer1/) reimplements the IMF's Q-CRAFT Excel workbook as an open-source Python web application. The [calculation engine](https://github.com/Teal-Insights/QCraft-App/tree/main/packages/qcraft-engine) is a standalone package with automated parity tests against the original Excel tool.
