...
**Country choice.** Pick the country you work on, because the capstone is a rehearsal for the document you will actually have to write. Pick Uganda instead if you want a run you can compare against the published section @sec-m4 works through. Avoid Ethiopia and Zambia unless you want to extend @sec-m4, since you have already worked those.
