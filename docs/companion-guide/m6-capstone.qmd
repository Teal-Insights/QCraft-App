...
- This module also closes the loop on @sec-m0, so you can see what changed
:::
...
**The single disqualifying error**, worth naming separately because it recurs: reporting the Adapted-to-Unadapted gap as the value of adaptation. It is the benefit side with the cost side missing (@sec-m4, independent problem).
...
## DRAFT FOR TEAL: the answers, and what a wrong one now means
