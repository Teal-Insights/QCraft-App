...
**Two follow-ups are designed into the course rather than left as an afterthought, and they ship with the workshop materials below.**
...
**Spacing beats massing, and the IMF's independent evaluators found that training with hands-on follow-up sticks while the standalone workshop decays (IEO, 2022).** The follow-up is the part that makes the rest count.
