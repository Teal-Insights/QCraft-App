...
export function buildReadme(
  ...
  out.push(
    ...
    '',
    wrap(
      'Verification status: baseline parity is exact for 147 of 147 tested ' +
        'countries. Climate-scenario parity is confirmed for ratio metrics only.',
    ),
    '',
    wrap(
      'Climate damage: FADCP Climate Dataset (Centorrino, Massetti and Tagklis, ' +
        '2024), building on Kahn et al. (2021). Macrofiscal data: IMF World ' +
        'Economic Outlook. Population: UN World Population Prospects.',
    ),
    '',
    wrap(
