...
<footer class="docfoot">
  ...
  <p>Climate damage: FADCP Climate Dataset (Centorrino, Massetti and Tagklis, 2024), building on Kahn et al. (2021). Macrofiscal data: IMF World Economic Outlook. Population: UN World Population Prospects. Generated by ${escapeHtml(manifest.app.name)} ${escapeHtml(manifest.app.version)} on ${escapeHtml(dateHuman)}.</p>
</footer>
</main>
</body>
</html>
